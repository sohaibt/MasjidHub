    ...
    <section id="contact" className="py-16 bg-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            {address && (
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-brandSoft flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex gap-3 pt-4">
              {config.facebook_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-surfaceAlt flex items-center justify-center hover:bg-brandSoft transition-colors"
                  aria-label="Facebook"
                >
          ...
          {/* Google Maps embed */}
          <div className="rounded-xl overflow-hidden border border-line shadow-sm h-[350px] md:h-full min-h-[300px]">
            {config.google_maps_embed_url ? (
              ...
              <div className="w-full h-full bg-surfaceAlt flex items-center justify-center text-faint">
